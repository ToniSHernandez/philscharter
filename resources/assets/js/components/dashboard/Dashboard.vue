<template>
    <div>
        <div class="container mx-auto min-h-full py-2 px-1">
            <div v-if="mobileMenuOpen || section == 'dashboard'" class="flex items-center justify-center flex-wrap">
                <div class="h-48 w-full sm:w-1/3 h-8 flex-grow p-1">
                ...
                <div class="h-48 w-1/2 sm:w-1/3 h-8 flex-grow p-1">
            ...
            <div v-if="section == 'services'">
                <h1 class="text-white text-5xl font-normal mt-4 pb-1 border-b border-grey-dark">Services</h1>

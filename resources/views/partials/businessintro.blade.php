<div class="bg-cover"
     style="background-image: url('/img/background-photo.png');">
    <div class="business-into bg-secondary-80 py-10">
        <div class="pb-6">
            <img class="block mx-auto h-24 md:h-32 lg:h-48 rounded-full mx-auto"
                 src="/img/avatar/phil-headshot.png"

...
<body class="bg-white h-screen">
    ...
    >
        ...
        >
                    ...
                    <div class="flex items-center justify-center h-full">
                        ...
                        <div class="flex-1 text-right">
                            ...
                            <nav class="hidden lg:flex text-center justify-end flex-wrap items-center">
                                ...
                                <a class="facebook inline-block h-10" href="https://www.facebook.com/philscharterservice/n" target="_blank">
            ...
            <div class="mid flex-grow lg:pt-10">
                @yield('content')
            </div>
        ...
        <div v-if="mobileMenuOpen" class="mobile-menu bg-white py-6 relative z-30">
            <nav>
                <a class="block w-full inline-block w-full my-2 px-3 no-underline uppercase font-bold text-grey-dark" href="/about" >About</a>
                <a class="block w-full inline-block w-full my-2 px-3 no-underline uppercase font-bold text-grey-dark" href="/trips-rates">Trips & Rates</a>
                <a class="block w-full inline-block w-full my-2 px-3 no-underline uppercase font-bold text-grey-dark" href="/albums">Photos</a>
                ...
                <a class="facebook inline-block h-10 m-3" href="https://www.facebook.com/philscharterservice/" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.02 34.02" class="h-10" style="enable-background:new 0 0 50 50;" xml:space="preserve">
                        <path fill="#43609C" d="M17,34A17,17,0,1,0,0,17,17,17,0,0,0,17,34"></path>
                        <path fill="#FFF" d="M12.9,14.13h1.76V12.42a4.57,4.57,0,0,1,.57-2.64A3.13,3.13,0,0,1,18,8.5a11.05,11.05,0,0,1,3.15.32l-.44,2.6a5.94,5.94,0,0,0-1.42-.21c-.68,0-1.3.25-1.3.93v2h2.8l-.2,2.54H18v8.84h-3.3V16.67H12.9Z"></path>
                    </svg>

...
>
                ...
                <div class="flex items-center justify-center h-12 px-2">
                    ...
                    <div class="flex-1 text-right">
                        <div class="inline-block lg:hidden">
                            <button @click="toggleMobileMenu" class="flex items-center px-3 py-2 border rounded text-kma border-kma">
                        ...
                        <nav class="hidden lg:flex justify-end">
                            <a class="no-underline hover:underline text-grey-darker text-sm mr-2" href="{{ url('/') }}">Back
                                to website</a>
    ...
    <div v-if="mobileMenuOpen" class="mobile-menu bg-grey-darker py-6 relative z-30">
        <nav>
            ...
            <a class="block w-full sm:inline-block my-3 p-3 no-underline uppercase font-bold cursor-pointer text-white" @click="changesection('photoalbums')" >Photo Albums</a>

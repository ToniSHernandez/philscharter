...
@section('content')
    ...
    <div class="content">
        <div class="container mx-auto p-4 md:my-10">
            <div class="px-4 pb-4">
                <h1 class="text-brand-darker font-bold mb-3">Trips & Rates</h1>
                <p class="leading-normal text-grey-darkest font-medium mb-3">I fish out of a 2008 23-foot Ranger bay boat powered by a
                    2017 Suzuki 300. Fishing trips include rod, reels, all tackle, bait, license, fish cleaned and
                    bagged!</p>
                <p class="leading-normal text-grey-darkest font-medium mb-3">Half day trips are the most popular. There’s no long run to
